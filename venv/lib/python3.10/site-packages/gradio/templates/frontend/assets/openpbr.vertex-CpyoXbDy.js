...
import './vertexColorMixing-lGRueUJg.js';
...
import './shadowsVertex-C2oEL7DR.js';
...
// Do not edit.
const name$3 = "openpbrVertexDeclaration";
const shader$3 = `uniform mat4 view;uniform mat4 viewProjection;uniform vec4 vEyePosition;
#ifdef MULTIVIEW
...
const shader$2 = `#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
...
const shader$1 = `#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
...
export { openpbrVertexShader };
//# sourceMappingURL=openpbr.vertex-CpyoXbDy.js.map
