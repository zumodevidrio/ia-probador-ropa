...
import './oitFragment-DqU8LdKi.js';
import './openpbrUboDeclaration-DHUCn5N9.js';
import './pbrDebug-WxFBjUNg.js';
import './shadowsFragmentFunctions-FBZ0FSPi.js';
import './samplerFragmentDeclaration-B2WHAlKv.js';
...
const shader$g = `#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
const shader$9 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
const shader$7 = `var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
const shader$6 = `var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
const shader$4 = `var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
export { openpbrPixelShaderWGSL };
//# sourceMappingURL=openpbr.fragment-DUYnpyLB.js.map
