...
import './shadowsVertex-a0onirRa.js';
import './morphTargetsVertexDeclaration-Cz0ikt3y.js';
import './logDepthDeclaration-C6VLMPiR.js';
import './morphTargetsVertex-CmA-Z_bj.js';
import './bonesVertex-BN7qPHq5.js';
...
// Do not edit.
const name$2 = "openpbrNormalMapVertexDeclaration";
const shader$2 = `#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
...
// Do not edit.
const name$1 = "openpbrNormalMapVertex";
const shader$1 = `#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
...
export { openpbrVertexShaderWGSL };
//# sourceMappingURL=openpbr.vertex-mfPZePAe.js.map
