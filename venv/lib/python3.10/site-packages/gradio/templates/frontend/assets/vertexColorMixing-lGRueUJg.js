...
// Do not edit.
const name$7 = "decalVertexDeclaration";
const shader$7 = `#ifdef DECAL
...
const shader$2 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
//# sourceMappingURL=vertexColorMixing-lGRueUJg.js.map
