...
// Do not edit.
const name$b = "pbrFragmentExtraDeclaration";
const shader$b = `varying vPositionW: vec3f;
#if DEBUGMODE>0
...
// Do not edit.
const name$a = "subSurfaceScatteringFunctions";
const shader$a = `fn testLightingForSSS(diffusionProfile: f32)->bool
...
// Do not edit.
const name$9 = "pbrHelperFunctions";
const shader$9 = `#define MINIMUMVARIANCE 0.0005
...
// Do not edit.
const name$8 = "pbrDirectLightingSetupFunctions";
const shader$8 = `struct preLightingInfo
{lightOffset: vec3f,
...
// Do not edit.
const name$7 = "pbrDirectLightingFalloffFunctions";
const shader$7 = `fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
// Do not edit.
const name$6 = "pbrBlockReflectance0";
const shader$6 = `var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
// Do not edit.
const name$5 = "pbrDirectLightingFunctions";
const shader$5 = `#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
// Do not edit.
const name$4 = "pbrIBLFunctions";
const shader$4 = `#if defined(REFLECTION) || defined(SS_REFRACTION)
...
// Do not edit.
const name$3 = "pbrBlockNormalGeometric";
const shader$3 = `var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
// Do not edit.
const name$1 = "pbrBlockPrePass";
const shader$1 = `#if SCENE_MRT_COUNT>0
...
//# sourceMappingURL=pbrDebug-WxFBjUNg.js.map
