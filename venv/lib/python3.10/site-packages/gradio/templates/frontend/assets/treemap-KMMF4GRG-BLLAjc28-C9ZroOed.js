import { m as map$1, f as flatten$1, a as min } from './min-BP3TZd4l-DOaP9HiD.js';
import { r as reduce$1, a as forEach$1, f as filter$1, c as baseFlatten$1, b as baseUniq$1, m as baseIteratee$1 } from './_baseUniq-CrYdfo_J-C1cWc0s3.js';
import { b7 as isEmpty$1 } from './mermaid.core-vMMZVCDT-CT2eqvo9.js';
...
function uniqBy(array2, iteratee) {
  return array2 && array2.length ? baseUniq$1(array2, baseIteratee$1(iteratee)) : [];
}
...
function overRest(func2, start, transform) {
  start = nativeMax$2(start === void 0 ? func2.length - 1 : start, 0);
  return function() {
...
function initCloneArray(array2) {
  ...
  if (length && typeof array2[0] == "string" && hasOwnProperty$6.call(array2, "index")) {
...
function createAggregator(setter, initializer) {
  return function(collection, iteratee) {
    var func2 = isArray(collection) ? arrayAggregator : baseAggregator, accumulator = {};
...
function reduce(collection, iteratee, accumulator) {
  ...
  return func2(collection, baseIteratee(iteratee), accumulator, initAccum, baseEach);
}
...
function alternation(atn, rule, alternation2) {
  ...
  const alts = map$1(alternation2.definition, (e) => atom(atn, rule, e));
...
function block(atn, rule, block2) {
  const handles = filter$1(map$1(block2.definition, (e) => atom(atn, rule, e)), (e) => e !== void 0);
  if (handles.length === 1) {
    return handles[0];
...
export { parse as p };
//# sourceMappingURL=treemap-KMMF4GRG-BLLAjc28-C9ZroOed.js.map
