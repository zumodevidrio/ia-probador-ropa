...
const shader$4 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
// Do not edit.
const name$3 = "lightFragmentDeclaration";
...
// Do not edit.
const name$2 = "lightUboDeclaration";
...
// Do not edit.
const name$1 = "ltcHelperFunctions";
const shader$1 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
//# sourceMappingURL=shadowsFragmentFunctions-Dr-0zda-.js.map
