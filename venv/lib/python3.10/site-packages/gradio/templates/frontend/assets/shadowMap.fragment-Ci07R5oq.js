...
import './packingFunctions-CXYnWyvs.js';
import './clipPlaneFragment-B1ZReT1E.js';
import './index-CDZuCcOm.js';

// Do not edit.
const name$3 = "bayerDitherFunctions";
const shader$3 = `fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
const shader$1 = `var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
export { shadowMapPixelShaderWGSL };
//# sourceMappingURL=shadowMap.fragment-Ci07R5oq.js.map
