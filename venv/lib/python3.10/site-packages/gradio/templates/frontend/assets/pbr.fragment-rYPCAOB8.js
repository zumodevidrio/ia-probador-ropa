...
import './oitFragment-CIDD3TZt.js';
import './pbrUboDeclaration-CtJCbmEt.js';
import './pbrDebug-CLmJa3wk.js';
import './shadowsFragmentFunctions-Dr-0zda-.js';
...
// Do not edit.
const name$m = "samplerFragmentAlternateDeclaration";
const shader$m = `#ifdef _DEFINENAME_
...
// Do not edit.
const name$l = "pbrFragmentSamplersDeclaration";
const shader$l = `#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
// Do not edit.
const name$k = "pbrBlockAlbedoOpacity";
const shader$k = `struct albedoOpacityOutParams
...
// Do not edit.
const name$j = "pbrBlockReflectivity";
const shader$j = `struct reflectivityOutParams
...
// Do not edit.
const name$i = "pbrBlockAmbientOcclusion";
const shader$i = `struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
// Do not edit.
const name$h = "pbrBlockAlphaFresnel";
const shader$h = `#ifdef ALPHAFRESNEL
...
// Do not edit.
const name$g = "pbrBlockAnisotropic";
const shader$g = `#ifdef ANISOTROPIC
...
// Do not edit.
const name$f = "pbrBlockReflection";
const shader$f = `#ifdef REFLECTION
...
// Do not edit.
const name$e = "pbrBlockSheen";
const shader$e = `#ifdef SHEEN
...
// Do not edit.
const name$d = "pbrBlockClearcoat";
const shader$d = `struct clearcoatOutParams
...
// Do not edit.
const name$c = "pbrBlockIridescence";
const shader$c = `struct iridescenceOutParams
...
// Do not edit.
const name$b = "pbrBlockSubSurface";
const shader$b = `struct subSurfaceOutParams
...
// Do not edit.
const name$a = "pbrBlockReflectance0";
const shader$a = `float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
// Do not edit.
const name$9 = "pbrClusteredLightingFunctions";
const shader$9 = `#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
// Do not edit.
const name$8 = "pbrBlockNormalFinal";
const shader$8 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
// Do not edit.
const name$7 = "pbrBlockLightmapInit";
const shader$7 = `#ifdef LIGHTMAP
...
// Do not edit.
const name$6 = "pbrBlockGeometryInfo";
const shader$6 = `float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
// Do not edit.
const name$5 = "pbrBlockReflectance";
const shader$5 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
// Do not edit.
const name$4 = "pbrBlockDirectLighting";
const shader$4 = `vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
// Do not edit.
const name$3 = "pbrBlockFinalLitComponents";
const shader$3 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
// Do not edit.
const name$2 = "pbrBlockFinalUnlitComponents";
const shader$2 = `vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
// Do not edit.
const name$1 = "pbrBlockFinalColorComposition";
const shader$1 = `vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
//# sourceMappingURL=pbr.fragment-rYPCAOB8.js.map
