...
const shader$a = `varying vec3 vPositionW;
#if DEBUGMODE>0
...
const shader$9 = `bool testLightingForSSS(float diffusionProfile)
...
const shader$6 = `float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
const shader$3 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
//# sourceMappingURL=pbrDebug-CLmJa3wk.js.map
