...
import './pbrUboDeclaration-CBM37pax.js';
...
import './bumpFragment-CenONkET.js';
import './decalFragment-BdP-xS_i.js';
import './lightFragment-CEb5i7Tw.js';
...
// Do not edit.
const name$k = "samplerFragmentAlternateDeclaration";
const shader$k = `#ifdef _DEFINENAME_
...
// Do not edit.
const name$j = "pbrFragmentSamplersDeclaration";
const shader$j = `#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
// Do not edit.
const name$i = "pbrBlockAlbedoOpacity";
const shader$i = `struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
// Do not edit.
const name$h = "pbrBlockReflectivity";
const shader$h = `struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
// Do not edit.
const name$g = "pbrBlockAmbientOcclusion";
const shader$g = `struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
// Do not edit.
const name$f = "pbrBlockAlphaFresnel";
const shader$f = `#ifdef ALPHAFRESNEL
...
// Do not edit.
const name$e = "pbrBlockAnisotropic";
const shader$e = `#ifdef ANISOTROPIC
...
// Do not edit.
const name$d = "pbrBlockReflection";
const shader$d = `#ifdef REFLECTION
...
// Do not edit.
const name$c = "pbrBlockSheen";
const shader$c = `#ifdef SHEEN
...
// Do not edit.
const name$b = "pbrBlockClearcoat";
const shader$b = `struct clearcoatOutParams
...
// Do not edit.
const name$a = "pbrBlockIridescence";
const shader$a = `struct iridescenceOutParams
...
// Do not edit.
const name$9 = "pbrBlockSubSurface";
const shader$9 = `struct subSurfaceOutParams
...
const shader$6 = `var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
const shader$4 = `var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
const shader$2 = `var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
const shader$1 = `var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
//# sourceMappingURL=pbr.fragment-hf_e9iSO.js.map
