...
import './openpbrUboDeclaration-CY2HOKo3.js';
...
// Do not edit.
const name$h = "openpbrFragmentSamplersDeclaration";
const shader$h = `#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
// Do not edit.
const name$g = "openpbrNormalMapFragmentMainFunctions";
const shader$g = `#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
// Do not edit.
const name$f = "openpbrNormalMapFragmentFunctions";
const shader$f = `#if defined(GEOMETRY_NORMAL)
...
// Do not edit.
const name$e = "openpbrDielectricReflectance";
const shader$e = `struct ReflectanceParams
...
// Do not edit.
const name$d = "openpbrConductorReflectance";
const shader$d = `#define pbr_inline
...
// Do not edit.
const name$c = "openpbrBlockAmbientOcclusion";
const shader$c = `struct ambientOcclusionOutParams
...
// Do not edit.
const name$b = "openpbrGeometryInfo";
const shader$b = `struct geometryInfoOutParams
...
// Do not edit.
const name$a = "openpbrIblFunctions";
const shader$a = `#ifdef REFLECTION
...
// Do not edit.
const name$9 = "openpbrNormalMapFragment";
const shader$9 = `vec2 uvOffset=vec2(0.0,0.0);
...
// Do not edit.
const name$8 = "openpbrBlockNormalFinal";
...
// Do not edit.
const name$7 = "openpbrBaseLayerData";
const shader$7 = `vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
// Do not edit.
const name$6 = "openpbrCoatLayerData";
const shader$6 = `float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
// Do not edit.
const name$5 = "openpbrThinFilmLayerData";
const shader$5 = `#ifdef THIN_FILM
...
// Do not edit.
const name$4 = "openpbrFuzzLayerData";
const shader$4 = `float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
// Do not edit.
const name$3 = "openpbrEnvironmentLighting";
const shader$3 = `#ifdef REFLECTION
#ifdef FUZZ
...
// Do not edit.
const name$2 = "openpbrDirectLightingInit";
const shader$2 = `#ifdef LIGHT{X}
...
// Do not edit.
const name$1 = "openpbrDirectLighting";
...
export { openpbrPixelShader };
//# sourceMappingURL=openpbr.fragment-DqB3_Jl6.js.map
