...
/* empty css                                         */
function Pause($$renderer) {
  $$renderer.push(`<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect></svg>`);
}
function Trim($$renderer) {
...
function VolumeLevels($$renderer, $$props) {
  let { currentVolume } = $$props;
  if (currentVolume == 0) {
    $$renderer.push("<!--[-->");
    VolumeMuted($$renderer);
  } else {
    $$renderer.push("<!--[!-->");
...
//# sourceMappingURL=VolumeLevels-C0Xso12f.js.map
