...
import { a as attr, f as attr_class, i as stringify, j as clsx } from './index-K3l_dLem.js';
...
function HTML($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let {
      ...
      upload = null,
      server = {},
      watch_fn = (_propOrProps, _callback) => {
      },
      fire_watchers = (_changedKeys) => {
      },
      children
    } = $$props;
    let [has_children, pre_html_template, post_html_template] = (() => {
    ...
    {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<div${attr("id", random_id)}${attr_class(`${stringify(apply_default_css && !has_children ? "prose gradio-style" : "")} ${stringify(elem_classes.join(" "))}`, "svelte-26mp0t", { "hide": !visible, "has_children": has_children })}>`);
      if (has_children) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div${attr_class(clsx(apply_default_css ? "prose gradio-style" : ""))}></div> `);
        children?.($$renderer2);
        $$renderer2.push(`<!----> <div${attr_class(clsx(apply_default_css ? "prose gradio-style" : ""))}></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
...
//# sourceMappingURL=HTML-DrgcWH8K.js.map
